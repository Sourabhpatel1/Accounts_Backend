...
class Customers(CustomersBase, table=True):
    ...
    s_orders:Optional[List["SalesOrders"]] = Relationship(back_populates='customer')
    s_invoices:Optional[List["SalesInvoices"]] = Relationship(back_populates='customer')
    account_id:int = Field(foreign_key='accounts.id')
    account:"Accounts" = Relationship(back_populates='customers')
    return_vouchers:Optional[List["SalesReturnVouchers"]] = Relationship(back_populates='customer')
